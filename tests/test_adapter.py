...
class TestDatacrunchAdapter:
    ...
    def test_init_with_credentials(self):
        ...
        with patch("spotinfer.adapter.datacrunch_adapter.DataCrunchClient") as mock_client:
    ...
    def test_filter_by_gpu_type_case_insensitive(self, mock_datacrunch_client, mock_instance_types):
    ...
    def test_filter_by_gpu_type_no_matches(self, mock_datacrunch_client, mock_instance_types):
    ...
    def test_get_cheapest_offer_with_gpu_type(self, mock_datacrunch_client, mock_instance_types):
    ...
    def test_get_cheapest_offer_spot_pricing(self, mock_datacrunch_client, mock_instance_types):
